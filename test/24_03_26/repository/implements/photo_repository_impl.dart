...
import 'package:learn_dart_together/24_03_26/repository/implements/photo_repository_impl.dart';
import 'package:learn_dart_together/24_03_26/repository/interface/photo_repository.dart';
import 'package:test/test.dart';

void main() {
  group('PhotoRepository 메서드 테스트', () {
    PhotoRepository repo = PhotoRepositoryImpl();

    test('getPhotos 메서드 테스트', () async {
      final List<Photo> photoList = await repo.getPhotos(1);
      final given = photoList.map((e) => e.toJson()).toList();
      final expectValue = [
        {
          "albumId": 1,
          "id": 1,
