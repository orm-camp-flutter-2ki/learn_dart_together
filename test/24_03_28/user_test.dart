...
import 'package:learn_dart_together/24_03_28/repository/user_repository_impl.dart';
...
void main() {
  test('user test', () async {
    ...
    print(jsonString[0]['address']);
    expect(
        users.equals(
            jsonString.map((e) => UserDto.fromJson(e).toUser()).toList()),
        true);
  });
}
