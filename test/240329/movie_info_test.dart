...
import 'package:learn_dart_together/240329/repository/movie_info_repository_impl.dart';
import 'package:test/test.dart';
import 'package:collection/collection.dart';

void main() {
  test('movie ', () async {
    final repository = MovieInfoRepositoryImpl(MovieApi());

    final movies = await repository.getMovieInfoList();

    expect(movies.length, 20);
    expect(results.map((e) => MovieInfo.fromJson(e)).toList().equals(movies), true);
  });
}
