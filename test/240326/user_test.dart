...
main() {
  ...
  test('user test', () async {
    ...
    List<User> alteredlist = list.map((e) => User.fromJson(e)).toList();

    expect(alteredlist[5].userName, userList[5].userName);
    //expect(eq(alteredlist, userList), isTrue); // 다른 이유는???

    //expect(alteredlist, userList);
    // expect(eq(list.sublist(0, 10), userList.sublist(0, 10)), isTrue);
    // print(list.sublist(0, 10) == userList.sublist(0, 10));
    // print(list.sublist(0, 10).hashCode);
    // print(userList.sublist(0, 10).hashCode);
  });
}
