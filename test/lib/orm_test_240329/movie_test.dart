...
import 'package:learn_dart_together/orm_240329/03_repository/movie_repository_impl.dart';
import 'package:test/test.dart';

void main() async {
  final MovieRepository repository = MovieRepositoryImpl(MovieApi());

  test('movie test list', () async {
    final movieList = await repository.getMovieList();

    print(movieList.length);
    print(results.length);
    expect(movieList.length == results.length, true);
  });
}
