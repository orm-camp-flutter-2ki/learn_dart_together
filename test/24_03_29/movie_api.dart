...
void main() {
  group('MovieApi 인터페이스의', () {
    group('구현체 MovieApiImpl 클래스의', () {
      final MovieApi api = MovieApiImpl();

      // Future<MovieInfoDto> getMovieInfoDto() async
      test('getMovieInfoDto()는 서버에 요청한 json을 MovieInfoDto로 반환한다.', () async {
        // Given
        final expected = MovieInfoDto.fromJson(
            {
              "dates": {
                "maximum": "2024-04-24",
                "minimum": "2024-04-03"
        ...
        // When
        MovieInfoDto result = await api.getMovieInfoDto();
      ...
      test('getMovie(int id)는 서버에 요청한 json을 MovieDto로 반환한다.', () async {
        // Given
        final id = 1011985;
        final expected = MovieDto.fromJson(
            {
              "adult": false,
              "backdrop_path": "/1XDDXPXGiI8id7MrUxK36ke7gkX.jpg",
        ...
        // When
        MovieDto result = await api.getMovieDto(id);
