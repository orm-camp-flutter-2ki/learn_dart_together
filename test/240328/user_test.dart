...
import 'package:learn_dart_together/240328/repository/user_repository_impl.dart';
...
void main() {
  test('user', () async {
    final repository = UserRepositoryImpl(UserApi());

    final users = await repository.getUsers();

    print(json[0]['address']);
    expect(users.equals(json.map((e) => UserDTO.fromJson(e as Map<String, dynamic>).toUser()).toList()), true);
  });
}
