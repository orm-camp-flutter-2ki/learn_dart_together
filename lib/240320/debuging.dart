...
final String jsonString = '''{
 "collectionChartDataList": [
   ...
   {
     "collectionName": "collectionName111",
     "collectionSalePrice": [
       {
         "price": 59.75,
...
class Collection {
  ...
  Collection.fromJson(Map<String, dynamic> json)
      : collectionName = json['collectionName'] ?? '',
        collectionSalePrice = json['collectionSalePrice'] == null ? [] : (json['collectionSalePrice'] as List).map((e) => CollectionSalePrice.fromJson(e)).toList();
}
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) : collectionChartDataList = (json['collectionChartDataList'] as List).map((e) => Collection.fromJson(e)).toList();
}
...
void main() {
  ...
  Collection collection = data.collectionChartDataList[1];

  print(collection.collectionName);
  print(collection.collectionSalePrice.first.price);
}
