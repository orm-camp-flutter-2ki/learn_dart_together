...
import 'package:learn_dart_together/0402/model/book.dart';
import 'package:learn_dart_together/0402/model/user.dart';
import 'package:learn_dart_together/0402/service/book_service.dart';
import 'package:learn_dart_together/0402/service/book_service_impl.dart';
import 'package:learn_dart_together/0402/service/user_service.dart';
import 'package:learn_dart_together/0402/service/user_service_impl.dart';
  ...
  while (true) {
    ...
    switch(input) {
      ...
      case '2':
        ...
        UserDto newUser = UserDto(name: input1, address: input2, phone: input3, signUpDate: getDateTime(), birth: input4);
  ...
  while (true) {
    ...
    switch(input) {
      ...
      case '1':
        ...
        _bookService.rentBook(int.parse(userId ?? '1'), int.parse(bookId ?? '1'));
        break;
      case '2':
        break;
      case '3':
