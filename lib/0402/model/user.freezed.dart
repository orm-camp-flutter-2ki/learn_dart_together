...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, address: $address, phone: $phone, signUpDate: $signUpDate, birth: $birth)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, address, phone, signUpDate, birth);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String birth}) = _$UserImpl;
