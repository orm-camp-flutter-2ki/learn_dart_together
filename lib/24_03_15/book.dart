class Book implements Comparable<Book> { // Comparable 인터페이스 구현
  ...
  String cutDateTime(DateTime publishDate) { // 이렇게 일반 함수로 접근을 해도 될까요?
  ...
  bool operator ==(Object other) {
    if (identical(this, other)) {
      ...
      return title == other.title &&
        cutDateTime(publishDate) == cutDateTime(other.publishDate);
    }
  }

  @override
  int get hashCode => title.hashCode ^ cutDateTime(publishDate).hashCode; // 비트 연산자
