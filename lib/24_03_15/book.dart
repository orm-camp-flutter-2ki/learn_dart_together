  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
          other is Book &&
              toString() ==
                  other
                      .toString(); //this book에 문자열로 반환한것과 other book에 문자열로 반환한것이 같은지 확인
...
void main() {
  final Book book1 = Book(
      title: '신승찬1', comment: '코멘트', publishDate: DateTime.parse('2024-01-03'));
  final Book book2 = Book(
      title: '신승찬2', comment: '코멘트', publishDate: DateTime.parse('2024-01-01'));
  final Book book3 = Book(
      title: '신승찬3', comment: '코멘트', publishDate: DateTime.parse('2024-01-02'));
